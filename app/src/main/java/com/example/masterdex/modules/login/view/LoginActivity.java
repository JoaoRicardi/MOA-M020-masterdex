package com.example.masterdex.modules.login.view;

import android.content.Intent;

import com.example.masterdex.R;
import com.example.masterdex.modules.cadastro.view.CadastroActivity;
import com.example.masterdex.modules.esqueciminhasenha.view.EsqueciASenhaActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void irParaEsqueciSenha() {
        Intent intent = new Intent(this, EsqueciASenhaActivity.class);
        startActivity(intent);
    }
